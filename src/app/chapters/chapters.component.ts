...
export class ChaptersComponent {
  ...
  chapters = signal<Chapter[]>([
    ...
    },
    {
      ...
      number: '1950-1951',
      title: '',
      titleItalic: 'La Dépèche marocaine',
    ...
    },
   {
      ...
      description: 'Le journaliste « évolue entre l’objectivité souvent glaciale de données minutieusement collationnées et la pulsion passionnelle que suscitent en lui le drame dont il est témoin, la catastrophe, la brutalité, la sottise triomphante, l’injustifiable espérance. Il s’efforce d’embrasser d’un même regard les ingrédients disparates qui, selon une recette inconnue, composent les soubresauts de l’actualité. Il sait ne pas y parvenir. Alors, leur ouvrant ses colonnes, il sollicite le concours de ceux qui sont réputés savoir. Ou, plus rarement, de ceux qui voient. Et voient différemment. » Ce qu’Arthur Rimbaud exprime dans Le bateau ivre en 1871 : « Et j’ai vu quelquefois ce que l’homme a cru voir ! » \n' +
        '[…] \n' +
    ...
    },
    {
      ...
      titleItalic: '',
      description: 'Un comité de pilotage se constitue, travaille sur le projet d’orientation du Cercle. Claude Julien rédige l’Acte constitutif, synthèse des travaux du comité de pilotage : « La seule démarche fructueuse consiste à rassembler dans le respect d’expériences et d’opinions diverses, tous ceux qui perçoivent la nécessité de porter un regard libre sur ce monde changeant et d’engager une réflexion commune sur ses évolutions probables, souhaitables, possibles… » afin de venir au secours de la démocratie. Il s’agit de proposer « des moyens de conduire ensemble cette conquête d’une pleine citoyenneté que d’aucuns voudraient restreindre pour la contrôler plus étroitement. » À cet Appel lancé par les membres du comité répondent en moins de deux mois cent fondateurs. Le Cercle de Paris peut naître avec Claude Julien à sa tête. \n' +
        '[…] \n' +
        'Parallèlement, des Cercles Condorcet naissent en province. Claude Julien et Michel Morineau arpentent le pays afin de soutenir les premiers pas d’un bon nombre d’entre eux. Chaque déplacement est l’occasion pour Claude Julien d’une conférence publique dont la presse locale fait généralement écho. Un thème fédère : la démocratie au travers des sujets tels que « Égalité des chances dans une société en mutation », « Démocratie et liberté », « Réinventer la République », « Réinventer la République dans un monde en mutation », « République d’experts ou de citoyens ? », « La presse face aux nouveaux médias », « Les inégalités et la démocratie »…',
      page: 'p. 235',
    },
    {
      id: 7,
      number: '1990-1998',
      title: 'Engagement dans la Ligue',
      titleItalic: '',
      description: 'Claude Julien a été élu président de la Ligue avec une demande précise de son prédécesseur : « Faire sortir la Ligue du pré carré de l’Éducation nationale [et] ouvrir la Ligue au monde. » Deux objectifs que Claude Julien embrasse avec enthousiasme, tout en respectant trois axes définis par les militants : l’intervention politique de la Ligue, le renforcement de son efficacité et la confirmation de la vitalité de leur réflexion. Le chantier est vaste… Il voit clairement l’impulsion qu’il souhaite donner à la Ligue : « à mon avis, on ne peut pas séparer le social de l’économique : on ne peut pas considérer les acteurs sociaux simplement comme des pompiers qui iraient éteindre les incendies allumés par un système économique qui crée des déséquilibres et des exclusions. Il faut donc ajouter à cette pratique sociale une réflexion sur les causes de l’exclusion, de l’échec scolaire, de l’illettrisme, de la délinquance juvénile, du non-accès de certains à la culture, aux loisirs. […] Il ne faut pas se contenter d’éteindre les incendies, il faut également faire en sorte, par une autre politique économique, qu’il n’y ait pas de foyers d’incendie aussi fréquemment allumés. […] Il faut essayer de suggérer des réponses politiques qui passeraient par l’État, les régions, les départements ou les municipalités. Je pense aussi que l’on peut, au besoin, dénoncer les pratiques de l’État ou du gouvernement qui vont parfois à contre-courant de ce que nous souhaitons ou qui portent l’action sur un autre terrain que celui qui nous paraît primordial. Autre chose : la Ligue a, depuis longtemps, un secteur international très important qui favorise des échanges. Toutes les déficiences, tous les problèmes de nos sociétés ont des causes qui sont à la fois nationales et mondiales ; nous devons donc approfondir la connaissance que nous pouvons avoir des mécanismes mondiaux qui fabriquent des injustices, des exclusions, des inégalités. » \n' +
        '[…] \n' +
        '« Il nous aidait à voir loin, les pieds sur terre », témoignera Gilbert Auzias en décembre 2018.',
      page: 'p. 246',
    },
  ]);
