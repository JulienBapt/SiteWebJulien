...
export class GalleryComponent {
  photos = signal<Photo[]>([
    ...
    },
    {
      ...
      caption: 'Claude et Jacques Lanzmann à Cuba',
      year: '1958',
    },
    {
      src: 'assets/images/1970_Conf_de_rédaction.jpg',
      alt: 'Claude conférence de rédaction',
      caption: 'Claude à une conférence rédaction',
      year: '1970',
    },
    {
    ...
    },
    {
      ...
      caption: 'Claude construit un mur en pierre sèche au Buguet-Haut',
      year: '1978',
    },
    {
