  ...
  chapters = signal<Chapter[]>([
    ...
    },
    {
      ...
      description: 'Tout n’est cependant pas simple : « le jour que j’attendais depuis longtemps est arrivé. Nous sommes libérés des Allemands. Mais la liberté n’est encore pas complète. Il faut libérer les esprits. C’est le plus dur. […] Ce qui est à craindre, c’est, par réaction, un nazisme français. En tout cas, au-tour de moi, on emploie, sous l’étiquette “communisme” ou sans étiquette du tout, des procédés allemands… » Liesse, bien compréhensible de la foule, mais aussi égarements qui ne lui conviennent pas du tout. « Avec quelques jeunes camarades appartenant à divers mouvements d’Action Catholique, nous sentions bien qu’il fallait d’urgence prendre des mesures pour éviter tout débordement. […] Mes amis me confièrent donc le soin d’aller voir le commandant Dunoyer de Segonzac pour lui présenter notre requête. Je lui exposai nos observations et notre désir de faire respecter la “loi du maquis”. Il m’écouta avec une ostensible bienveillance, dans un silence qui ne pouvait que m’intimider davantage. Il me donna volontiers raison. » Dunoyer de Segonzac estime nécessaire d’informer la population et en confie la charge à Claude Julien. S’en suit un échange durant lequel le commandant du maquis balaie chaque objection du jeune jéciste :\n' +
        ...
        '•	Il faut de l’argent. Ce n’est pas un problème : « Dunoyer de Segonzac m’invita à le suivre jusqu’à l’autre extrémité de la vaste pièce où nous nous trouvions. Il marchait à grands pas, en faisant toujours claquer sa badine sur ses guêtres de cavalier. Et là, de la pointe du pied droit, il souleva le couvercle d’un grand coffre en bois simplement posé sur le sol, sans la moindre surveillance. Je n’avais jamais vu autant d’argent : […] un bon mètre cube de liasses de billets de banque… Cette fortune provenait à la fois des fonds parachutés par Londres et du trésor de guerre confisqué aux Allemands… » Claude Julien est prié de remplir la sacoche qu’il a avec lui.\n' +
        'Ainsi commence l’aventure de Debout, « un éphémère petit journal quotidien ».',
      page: 'p. 48',
    },
    {
      id: 2,
      ...
      description: 'Claude Julien accentue l’orientation internationale du journal avec une rubrique qui fera chaud aux cœurs des membres du conseil d’administration, une « Chronique internationale » construite sur un réseau de correspondants dans les capitales méditerranéennes. Véritable tour de force : Claude Julien a trouvé douze correspondants particuliers pour tenir ses lecteurs au courant de l’actualité méditerranéenne. Le mercredi, un supplément intitulé « La vie internationale », permet de publier des études d’actualité (les élections aux États-Unis, l’intervention de la Chine en Corée, son agriculture, la viabilité de l’État d’Israël…), souvent signées, ce qui n’est pas si courant dans ce journal, mais signées de noms très majoritairement inconnus… Tout comme ceux des « Chroniques internationales ». Un auteur sort du lot, George Bidault, publié une fois par semaine durant deux mois. Quand on sait que l’homme, alors ministre des Affaires étrangères, donne en 1947 l’instruction au général Juin « de “destituer” le Sultan s’il refusait de signer les dahirs », on peut être surpris que Claude Julien ait fait appel à lui. Les nouvelles plus brèves concernant les pays arabes du pourtour méditerranéen ont leur place dans la rubrique « Méditerranée » et dans des revues de presse. Une dizaine de « portraits politiques » complètent régulièrement la page. Enfin apparaît début novembre une revue de presse dont le nom, donc la nature, va évoluer : « L’opinion mondiale devant … » qui se transforme le 29 novembre en une revue de presse centrée sur la presse égyptienne et parfois celle du Caire.\n' +
        'Il remplace la page culturelle hebdomadaire par trois pages réparties sur trois jours : « Sciences et spectacles » le mardi, « Variétés » le vendredi et « Lettres, arts, philosophie » le dimanche. Construites en piochant dans la production d’Extinfor, elles permettent aux Tangérois d’être au fait de l’actualité théâtrale, cinématographique à Paris, de s’ouvrir à la littérature et à la philosophie en lisant des plumes, telles que celle de Julien Benda, ou de Paul Guth. Pour compléter, quelques conseils de lecture, à peu près toutes les deux semaines, le plaisir de lire des contes et nouvelles par trois fois. Fin janvier, s’inspirant peut-être de la pratique observée lors de son court passage à La Vie catholique illustrée, Claude Julien publie en feuilleton quotidien un roman de Jean Rounault, Mon ami Vassia, ouvrage dont l’auteur explique l’histoire dans quatre articles publiés les jours précédents. Fait extrêmement rare, ces publications sont réservées à La Dépêche marocaine comme en atteste la mention « Copyright by Jean Rounault et La Dépêche marocaine ». L’histoire ne dit pas comment Claude Julien a trouvé cette pépite. Retenons cette place accordée à la littérature, signe précurseur de ce qu’il mettra en place au Monde et au Monde diplomatique.',
      page: 'p. 82',
    },
    {
      id: 3,
