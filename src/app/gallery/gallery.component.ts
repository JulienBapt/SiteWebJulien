...
export class GalleryComponent {
  photos = signal<Photo[]>([
    ...
    },
   {
      ...
      alt: 'Claude Julien et ses amis de la JEC à Lyon',
    ...
    },
    {
      ...
      alt: 'Claude Julien aux États-Unis avec Martin McLaughlin, responsable des YCS',
    ...
    },
    {
      ...
      alt: 'Claude Julien et Jacques Decornoy (©Scianna)',
